...
(2, 'Qt. Pacheca', 'Fazenda_Sul', '224455667', 'pacheca@mail.exemplo.pt', 1),
(3, 'Finagra', 'Reguengos', '266509270', 'esporao@esporao.com', 2),
(4, 'Dão Sul', NULL, NULL, NULL, 3),
(5, 'Kolheita Ideias', 'Piracicaba', '965742289', 'kolheita@mail.com', 5),
(6, 'Kolheita Ideias', NULL, NULL, NULL, 1),
(7, 'Adriano Ramos', 'São Joaquim', '998752285', 'adriano@mail.sul.com', 3),
(8, 'Uvas&Vinhos', 'Caxias do Sul', '987654321', 'uvasevinhos@mail.qualidade', 4);
...
--
ALTER TABLE `casta`
  MODIFY `idCasta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de tabela `produtor`
--
ALTER TABLE `produtor`
  MODIFY `idprodutor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
