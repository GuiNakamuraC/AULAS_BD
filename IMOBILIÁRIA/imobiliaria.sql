...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22-Ago-2024 às 16:06
...
INSERT INTO `aluguel` (`id_aluguel`, `data_inicio`, `data_fim`, `valor`, `id_inquilino`, `id_imovel`, `id_corretor`) VALUES
(1, '2024-01-01', 2024, '99.99', 1, 1, 1),
(2, '2024-02-01', 2024, '99.99', 2, 2, 2),
(3, '2024-03-01', 2024, '99.99', 3, 3, 3),
(4, '2024-04-01', 2024, '99.99', 4, 4, 4),
(5, '2024-05-01', 2024, '99.99', 5, 5, 5),
(6, '2024-06-01', 2024, '99.99', 6, 6, 6),
(7, '2024-07-01', 2024, '99.99', 7, 7, 7),
(8, '2024-08-01', 2025, '99.99', 8, 8, 8),
(9, '2024-09-01', 2025, '99.99', 9, 9, 9),
(10, '2024-10-01', 2025, '99.99', 10, 10, 10),
(11, '2024-11-01', 2025, '99.99', 11, 11, 1),
(12, '2024-12-01', 2025, '99.99', 12, 12, 2),
(13, '2025-01-01', 2025, '99.99', 13, 13, 3),
(14, '2025-02-01', 2025, '99.99', 14, 14, 4),
(15, '2025-03-01', 2025, '99.99', 15, 15, 5);
...
INSERT INTO `imovel` (`id_imovel`, `quant_banheiro`, `quant_quarto`, `lavanderia`, `garagem`, `piscina`, `extra`, `area`, `id_prop`) VALUES
(1, 2, 3, b'1', b'0', b'0', 'Salão de Arte', '120.50', 1),
(2, 2, 3, b'1', b'0', b'1', 'Jardim', '80.00', 1),
(3, 1, 2, b'0', b'1', b'0', 'Varanda', '200.00', 2),
(4, 3, 4, b'1', b'1', b'1', 'Churrasqueira', '95.00', 3),
(5, 2, 2, b'1', b'0', b'0', 'Sauna', '60.00', 4),
(6, 1, 1, b'0', b'1', b'1', 'Academia', '110.00', 5),
(7, 2, 3, b'0', b'1', b'0', 'Oficina', '150.00', 5),
(8, 3, 4, b'1', b'1', b'1', 'Pomar', '300.00', 5),
(9, 1, 2, b'1', b'0', b'0', 'Escritório', '75.00', 6),
(10, 2, 3, b'0', b'0', b'1', 'Biblioteca', '85.00', 6),
(11, 2, 2, b'1', b'1', b'0', 'Área Gourmet', '90.00', 7),
(12, 1, 1, b'0', b'1', b'0', 'Quarto de Hóspede', '50.00', 8),
(13, 2, 3, b'1', b'0', b'1', 'Sala de Jogos', '100.00', 9),
(14, 3, 5, b'1', b'1', b'1', 'Terreno Amplo', '500.00', 10),
(15, 1, 2, b'0', b'1', b'0', 'Terraço', '45.00', 10);
...
INSERT INTO `inquilino` (`id_inquilino`, `nome`, `data_nasc`, `CPF`, `email`, `telefone`, `id_fiador`) VALUES
(1, 'Maria Silva', '1990-02-14', '123.456.789-00', 'maria.silva@example.com', '(11) 91234-5678', 1),
(2, 'José Santos', '1985-05-30', '234.567.890-11', 'jose.santos@example.com', '(21) 92345-6789', 2),
(3, 'Ana Paula', '1992-08-22', '345.678.901-22', 'ana.paula@example.com', '(31) 93456-7890', 3),
(4, 'Ricardo Almeida', '1987-11-05', '456.789.012-33', 'ricardo.almeida@example.com', '(41) 94567-8901', 4),
(5, 'Juliana Costa', '1995-12-18', '567.890.123-44', 'juliana.costa@example.com', '(51) 95678-9012', 5),
(6, 'Pedro Henrique', '1983-01-10', '678.901.234-55', 'pedro.henrique@example.com', '(61) 96789-0123', 6),
(7, 'Tatiane Oliveira', '1991-04-25', '789.012.345-66', 'tatiane.oliveira@example.com', '(71) 97890-1234', 7),
(8, 'Lucas Ferreira', '1988-06-30', '890.123.456-77', 'lucas.ferreira@example.com', '(81) 98901-2345', 8),
(9, 'Camila Souza', '1994-07-15', '901.234.567-88', 'camila.souza@example.com', '(91) 99012-3456', 9),
(10, 'Roberto Lima', '1981-09-12', '012.345.678-99', 'roberto.lima@example.com', '(71) 90123-4567', 10),
(11, 'Fernanda Ribeiro', '1990-10-05', '123.456.789-01', 'fernanda.ribeiro@example.com', '(11) 91234-5678', 1),
(12, 'Carlos Eduardo', '1985-11-20', '234.567.890-12', 'carlos.eduardo@example.com', '(21) 92345-6789', 2),
(13, 'Juliana Martins', '1993-03-10', '345.678.901-23', 'juliana.martins@example.com', '(31) 93456-7890', 3),
(14, 'Marcelo Gomes', '1989-06-27', '456.789.012-34', 'marcelo.gomes@example.com', '(41) 94567-8901', 4),
(15, 'Gabriela Lima', '1994-04-10', '789.012.345-67', 'gabriela.lima@example.com', '(71) 97890-1234', 7);
...
--
ALTER TABLE `aluguel`
  MODIFY `id_aluguel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
